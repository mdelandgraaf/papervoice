...
DEFAULT_MODERATOR_INSTRUCTIONS = (
    ...
    " When a human directs a question to another participant, do not answer for them;"
    " give them the floor and let them speak for themselves."
    " Your role is to facilitate and keep time, not to act as the voice of every participant."
